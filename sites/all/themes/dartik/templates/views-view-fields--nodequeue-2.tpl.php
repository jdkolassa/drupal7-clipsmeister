...
<?php else: ?>
  <div class="clip_entry">
    <?php print $fields['position']->content; ?>. <?php print $fields['field_primary_outlet']->content; ?> (<?php print $fields['field_broadcast_format']->content; ?>), <?php print $fields['field_date']->content; ?>: <?php print $fields['field_custom_desc']->content; ?><br><br>
  </div>
