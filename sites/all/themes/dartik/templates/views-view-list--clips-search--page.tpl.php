...
<?php if ($fields['type'] = 'broadcast_clip'): ?>
	...
	<?php endif; ?>
<?php elseif ($fields['type'] = 'print_clip'): ?>
	<?php if (is_null($fields['field_clip_custom']->content)): ?>
  		<div class="clip_entry">
...
<?php else: ?>
	<div class="clip_entry">
	<?php print $fields['position']->content; ?>. <a href="<?php echo drupal_lookup_path('alias',"node/".$node->nid);?>"><?php print $title ?><br><br>
	</div>
<?php endif; ?>